...
public class ScientificActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scientific); // Men-set isi tampilan dengan layout dari file xml (activity_scientific)

        Toast toast = Toast.makeText(this, R.string.welcome_scientific, Toast.LENGTH_SHORT); // Membuat variabel (Toast) toast dan mengisinya dengan pesan selamat datang
        toast.setGravity(Gravity.CENTER_VERTICAL, 0, 70); // Mengatur posisi toast
        toast.show(); // Menampilkan toast

        WebView webView = (WebView) findViewById(R.id.webView_scientific); // Membuat variabel (WebView) webView dan mengisinya dengan webView_basic dari file xml
        ...
        webView.loadUrl("https://www.desmos.com/scientific"); // Memuat URL sumber untuk ditampilkan di webView

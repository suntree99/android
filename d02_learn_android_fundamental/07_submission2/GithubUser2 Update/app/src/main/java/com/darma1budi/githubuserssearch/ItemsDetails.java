...
public class ItemsDetails implements Parcelable {
	...
	protected ItemsDetails(Parcel in) {
	...
	public static final Creator<ItemsDetails> CREATOR = new Creator<ItemsDetails>() {
		@Override
		public ItemsDetails createFromParcel(Parcel in) {
			return new ItemsDetails(in);
		}

		@Override
		public ItemsDetails[] newArray(int size) {
			return new ItemsDetails[size];
		}
	};

...
//    private PersonListViewModel personListViewModel = ViewModelProvider(this, new PersonListViewModelFactory(this)).get(PersonListViewModel.class);
...
//        showLoading(true);
        ...
        Call<SearchResponse> search = ApiConfig.getApiService().getUserSearch(query);
...
//                        JSONArray jsonArray = (JSONArray) response.body().getItems();
